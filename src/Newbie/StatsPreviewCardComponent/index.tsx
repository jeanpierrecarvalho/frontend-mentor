...
function StatsPreviewCardComponent() {
  return (
    <div className="flex h-screen w-screen bg-[#0A0C1C] justify-center items-center">
      <div
        id="StatsPreviewCardComponent"
        className="w-[327px] h-[780px] md:w-[1100px] md:h-[446px] bg-[#1b1937] rounded-[8px]"
      >
        <div className="flex md:flex-row flex-col-reverse">
          <div className="flex flex-col md:w-[560px] md:pl-[72px] text-center md:text-left">
          ...
          <div className="md:w-[540px] bg-[#AB5CDB] opacity-75 rounded-t-[8px] md:rounded-r-[8px]">
            <img
              src={imgDesktop}
              className="imgDesktop hidden md:block w-full mix-blend-multiply rounded-r-[8px]"
              alt={"Some alt"}
            />
            <img
              src={imgMobile}
